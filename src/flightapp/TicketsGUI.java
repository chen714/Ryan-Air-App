...
public class TicketsGUI extends javax.swing.JFrame {
    ...
    private void costBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_costBtnActionPerformed
        ...
        //Giving discount option
            ...
            if(f.getCodeOption() == JOptionPane.YES_OPTION){ 
                /*int codeOption = JOptionPane.YES_NO_OPTION;
                JOptionPane.showConfirmDialog(null, "Would you like to use a discount code?");
                if(codeOption == JOptionPane.YES_OPTION){
                    f.setCodeOption(0);
                }
                else if(codeOption == JOptionPane.NO_OPTION){
                    f.setCodeOption(1);
                    JOptionPane.showMessageDialog(null, "No Prob");
                }
                while(f.getCodeOption() == JOptionPane.YES_OPTION){
                    //if(codeOption.charAt(0) == 'y' || codeOption.charAt(0) == 'Y' && codeOption.charAt(1) == 'e' && codeOption.charAt(2) == 's'){
                    /*if(codeOption == JOptionPane.YES_OPTION){
                    f.setCodeOption(JOptionPane.YES_OPTION);*/
            String codeAnswer = JOptionPane.showInputDialog(null, "Please input your discount code:");
                ...
                /*else if(codeAnswer == null || (codeAnswer != null && ("".equals(codeAnswer)))){
                    JOptionPane.showMessageDialog(null, "You didn't enter a code.", "OOPS!", JOptionPane.INFORMATION_MESSAGE);
                }
                else if(Integer.parseInt(codeAnswer) == JOptionPane.CANCEL_OPTION){
                    System.out.println("Cancel is pressed");
                    System.exit(0);
                }*/
                //Error statement for incorrect discount code
                else{
            ...
            //Calculating cost for standard class flyers, with no discount code, when "No" option is selected
                ...
                //f.setCodeOption(JOptionPane.NO_OPTION);
                //remove(codeOption);
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        /*if(classCombo.getItemCount() == 0){
            JOptionPane.showMessageDialog(null, "Please select a class type!", "I Think You Forgot Something...", JOptionPane.INFORMATION_MESSAGE);
        }*/
